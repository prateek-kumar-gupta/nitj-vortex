  ...
  return (
    <footer>
      ...
      <div className="footer-social-icons">
        ...
        <a 
          href="https://www.linkedin.com/company/vortex-club-nitj/" 
          target="_blank" 
          rel="noopener noreferrer"
          aria-label="LinkedIn"
        >
      ...
      <div className="footer-info">
        <p>© 2026 VORTEX • NIT Jalandhar Esports Club • <a href="mailto:vortex@nitj.ac.in" style={{ color: '#a0a0a8', textDecoration: 'none', transition: 'color 0.2s' }}>vortex@nitj.ac.in</a></p>
      </div>
    </footer>
  );
}
